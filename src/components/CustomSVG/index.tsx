...
export const AttachSVG = () => {
  return (
    <svg
      ...
      width="14.288"
      height="28.445"
      viewBox="0 0 14.288 28.445"
    >
      <path
        id="Path_663"
        data-name="Path 663"
        d="M404.874,259.762h1.92c0,.49,0,1,0,1.519,0,3.394-.059,6.789.056,10.178a2.208,2.208,0,0,0,1.192,1.693c.96.223,1.344-.628,1.343-1.555,0-4.417.034-8.834-.026-13.25a3.211,3.211,0,0,0-6.422-.02c-.052,5.494-.08,10.989.015,16.481a5.146,5.146,0,0,0,10.286-.109c.085-4.361.029-8.725.033-13.088,0-.584,0-1.168,0-1.836h1.891c0,5.271.186,10.492-.063,15.692-.178,3.709-3.69,6.39-7.411,6.194A7.029,7.029,0,0,1,401,274.828c-.085-5.492-.07-10.988,0-16.481a5.148,5.148,0,0,1,10.294-.132c.09,4.576.063,9.156.015,13.734a3.19,3.19,0,0,1-3.147,3.244,3.124,3.124,0,0,1-3.255-2.949C404.814,268.11,404.874,263.974,404.874,259.762Z"
        transform="translate(-400.941 -253.225)"
        fill="#111026"
      />
    </svg>
  )
